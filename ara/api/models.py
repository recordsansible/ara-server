...
class File(Base):
    ...
    content = models.ForeignKey(
        FileContent, on_delete=models.CASCADE, related_name="files"
    )
...
class Record(Base):
    ...
    playbook = models.ForeignKey(
        Playbook, on_delete=models.CASCADE, related_name="records"
    )
...
class Play(Duration):
    ...
    completed = models.BooleanField(default=False)
    playbook = models.ForeignKey(
        Playbook, on_delete=models.CASCADE, related_name="plays"
    )
...
class Host(Base):
    ...
    playbook = models.ForeignKey(
        Playbook, on_delete=models.CASCADE, related_name="hosts"
    )
...
class Stats(Base):
    ...
    playbook = models.ForeignKey(
        Playbook, on_delete=models.CASCADE, related_name="stats"
    )
